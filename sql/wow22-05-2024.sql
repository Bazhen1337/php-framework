...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 22 2024 г., 17:20
...
(5, 'Bazhen', 1, 'ДД', 'тектстектсткекст', '3', 'Бастион Адского Пламени', NULL, 'Держал агро', '2024-05-21'),
(6, 'Bazhen', 3, 'ДД', 'adszcwdawasdawdsadaw', '3', '1', 0, 'Ничего не запомнилось/ничего выдающегося', '2024-05-21'),
(7, 'Bazhen', 3, 'ДД', 'adszcwdawasdawdsadaw', '3', '1', 0, 'Ничего не запомнилось/ничего выдающегося', '2024-05-21'),
(8, 'Bazhen', 3, 'ДД', 'adszcwdawasdawdsadaw', '3', '1', 0, 'Ничего не запомнилось/ничего выдающегося', '2024-05-21'),
(9, 'Bazhen', 1, 'Танк', 'все понравилось норм тип ток долбаеб', '5', '26', 0, 'дает нужную инфу в чате', '2024-05-20'),
(10, 'Bazhen', 19, 'Танк', 'Агро слетало по кд, надо было ждать секунд 15 чтобы он его набрал, на втором босе и вовсе не выживал кароче даун, и еще писал типа хули вы агро снимаете долбаеб', '1', '19', 0, '8', '2024-05-08');
...
(16, 3, 'Sukaa', 'Танк', 'Паладин', 'Гном', 1),
(17, 3, 'asdwwe', 'ДД', 'Маг', 'Гном', 0),
(18, 3, 'asdwweasdzxc', 'Танк', 'Друид', 'Ночной эльф', 0),
(19, 1, 'Праведник', 'Танк', 'Паладин', 'Человек', 0);
...
(1, 'Bazhen', '$2y$10$XeL8H99DYp3YCRxGyZln9u9UHVpozEc.bTz/PC7Ej59mCv2T0C73i'),
(2, 'Likestorm', '322'),
(3, 'huilo', '1337');
