...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 16 2024 г., 17:12
...
INSERT INTO `comment` (`id`, `user_id`, `player_id`, `text`, `dungeon`, `d_level`, `note`, `date`) VALUES
(1, 1, 1, 'неплохо, но все нидил', 'Гробницы маны', 0, 'держит агро', '2024-05-16');
